...
- **Item 4, mutações sobreviventes no PIT** (124; 80% mortas, força 89%).
  `MineShaft` feito em 25-09 (37 → 1, que é equivalente). Faltam `Building`
  12, `ColonyCycle` 12, `Worker` 10, `ProfessionAssigner` 9, `Mine` 9,
  `ColonyGoals` 9.
