...
**Gerado em:** 2026-09-25 04:46 UTC
**Log analisado:** `latest.log`
**Sessoes no historico:** 5
...
| `construction_waiting_resources` | BuilderWork / WaitingWork | 5 | candidato a loop |
...
| `site_sweep_budget_exhausted` | RingSweep / BuildSiteScanner | 11 | candidato a loop |
...
| `FARMER` | `FARMING` | `RECOVERED` | `NO_TARGET` | 11 |
| `FARMER` | `FARMING` | `RECOVERED` | `SWEEP_INCOMPLETE` | 5 |
| `FARMER` | `FARMING` | `WAITING` | `SWEEP_INCOMPLETE` | 11 |
| `LUMBERJACK` | `COLLECT_WOOD` | `ABANDONED` | `WORK_STALLED` | 6 |
| `LUMBERJACK` | `COLLECT_WOOD` | `ERROR` | `WORK_STALLED` | 6 |
...
- `construction_waiting_resources`: 5 ocorrencias em BuilderWork / WaitingWork.
- `site_sweep_budget_exhausted`: 11 ocorrencias em RingSweep / BuildSiteScanner.
...
| `construction_waiting_resources` | 261 |
| `builder_pathing_stalled` | 116 |
| `missing_profession` | 90 |
| `site_sweep_budget_exhausted` | 135 |
