...
description: Operate WorldEdit safely for Minecraft 26.x and 1.21.x selections,
  region edits, masks, schematics, brushes, terrain shaping, and rollback. Use
  for command-driven world editing, not plugin development or general server
  administration.
---
