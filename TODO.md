...
- [ ] Residual de `FarmPlanGameTest.thenextturnafterahouseisnonresidential`: a rodada completa de 20-09 ainda abriu uma casa consecutiva; reproduzir a alternância com estado de vila isolado antes de alterar `HousePlans`.
- [ ] Residual de `SmelterGameTest.theOreInTheMineMouthChestIsCountedAndSmelted`: a fixture encontrou três baús em vez dos dois esperados; isolar o baú adicional antes de alterar a coleta do fundidor.
