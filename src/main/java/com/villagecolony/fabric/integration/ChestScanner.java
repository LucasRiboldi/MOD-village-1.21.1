 ...
 *
 * <p>Prefere sempre o baú que já existe. A criação é uma etapa única da
 * adoção da vila vanilla, com prova de cômodo e porta em
 * {@link VanillaBedChests}; ciclo de trabalhador só procura e reivindica.
 */
